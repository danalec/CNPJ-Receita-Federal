...
## Navegação Rápida
- Visão geral e início rápido: ../README.md
- Descrição oficial dos dados: descricao-dados.md
- Diagrama entidade–relacionamento (ER): diagrama_er.md
...
## Dados e Modelo
- Layout e campos (oficial): descricao-dados.md
- Diagrama ER (mermaid): diagrama_er.md
- Metadados (Receita Federal): https://www.gov.br/receitafederal/dados/cnpj-metadados.pdf

## Troubleshooting e Performance
- Erros comuns, dicas de performance e consultas exemplo: ../README.md
- Verificação de BOM com ripgrep (exemplo): `rg -nU "^\xEF\xBB\xBF" data/extracted_files/**/*.csv`

- Boas práticas de índices: boas-praticas-indices.md
